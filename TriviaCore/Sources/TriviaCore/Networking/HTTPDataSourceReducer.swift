...
public struct HTTPDataSourceReducer<ResponseType: Codable & Equatable>: ErrorProducer, Sendable {
    ...
    public enum Action: Equatable {
        ...
        case fetch(url: String, cachePolicy: NSURLRequest.CachePolicy, retry: Int = 0, requestId: UUID? = nil, decoder: JSONDecoder)
        case request(urlRequest: URLRequest, retry: Int = 0, requestId: UUID? = nil, decoder: JSONDecoder)
